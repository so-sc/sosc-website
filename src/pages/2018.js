...
const state18 = () => (
  <Report>
    <div className="page">
      <section className="2018-Report">
        <div className="container">
          <h1>2018 Yearly Report</h1>
                 ...
                 <br />
                  <br />04th and 5th May 
                    ...
                    <br />devhost:18 was the first annual Student Developers meet organised by Sahyadri Open-Source Community (SOSC)
                          ...
                          The event was open-to-all and was free of cost for anyone who was interested. 
                </li>
                <br />
                <li><h1>Python Bootcamp</h1>
                 <br />
                  <br />9th May 
                    <br />
                    <br />Python Bootcamp was a series of Python-workshops which was held for interested 
                          ...
                          These workshops were conducted by students from SOSC.
                </li>
                <br />
                <li><h1>Image Processing</h1>
                 <br />
                  <br />28th July 
                    <br />
                 ...
                 <br />
                  <br />1st September
                    ...
                    <br />Problem Solving 101 was a workshop dedicated to students to improve their problem solving and analysis skills. 
                          ...
                          It was an amazing 3 hours of hands on experience on solving various problems and teaching the students how to crack em.
                </li>
                <br />
                <li><h1>SOSC Family Expands as it hits a remarkable 100 members</h1>
                 <br />
                  <br />2nd September  
                    <br />
                    <br />Students of Sahyadri College of Engineering and Management were given the chance to join SOSC
                          ...
                          and the truly interested students were added to the Official members group with over 100+ Open Source Loving Members 
                </li>
                <br />
                <li><h1>The start of the Sahyadri Machine Learning Group(MLG)</h1>
                 <br />
                  <br />2nd September 
                    <br />
                    <br />The Sahyadri Machine Learning Group, also known as MLG is the newest addition to the clubs at SOSC.
                          ...
                          Machine Learning and Deep Learning research through projects and papers created by its members 
                </li>
                <br />
                <li><h1>Git+Github Workshop</h1>
                 <br />
                  <br />30th September
                    <br />
                    <br />This workshop was conducted by SOSC members and Sahyadri's very own GitHub campus expert, Musthaq Ahamad, who is also an SOSC member. 
                          ...
                          Enlightened most of the attendees with the usefulness of linux OS while working with open source technologies.
                </li>
                <br />
                <li><h1>The start of the Sahyadri Open Source Womens Community(SOSWC)</h1>
                 <br />
                  <br />1st October 
                    <br />
                    <br />The Sahyadri Open Source Womens community was another new addition to the various clubs under SOSC,
                          ...
                          and to increase the contribution stats of women in Open-Source and the various technical fields.     
                </li>
                <br />
                <li><h1>HacktoberFest HackNight</h1>
                 <br />
                  <br />13th October
                    <br />
                    <br />This was one of the most successful event our community conducted! 
                          ...
                          building something with their academic knowledge for the first time.
                </li>
                <br />
                <li><h1>Mentoring of PU students by SOSC members during Sahyadri Science Talent Hunt(SSTH)</h1>
                 <br />
                  <br />10th February 
                    <br />
                    <br />To create awareness on the importance of Projects and Research among the student community of pre-university level,
                          ...
                          various SOSC members were put in charge as mentors for these PU students, for guidance. 
                </li>
                <br />
                <li><h1>Data Science Workshop</h1>
                 <br />
                  <br />17th November 
                    <br />
                    <br />In this workshop, the Basics of data analysis was discussed.
                          ...
                          Statistical data analysis, Visual data analysis using plotly, matplotlib and seaborn
                </li>
                <br />
                <br />
                </ul>
